...
public class Main {
    public static void main(String[] args) {
        ...
        RongYaoClient myRongYao=new RongYaoClient();
        myRongYao.setTwoPinSocket(twoPinSoketChina);
        myRongYao.chargeRequest();

        // 情况二:然后坐飞机去美国旅游，美国某旅馆的墙上有只有一个三孔插座
        ...
        // 在美国，通过美国适配器，用三空插座充电
        myRongYao.setTwoPinSocket(americaAdapter);
        myRongYao.chargeRequest();


    }

    static void testTwoPin(TwoPinSocket twoPinSoket)
    {
